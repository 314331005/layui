	...
	<div class="row">
		<div class="col-md-12  formPanel">
			<div class="panel panel-default">
			  ...
			  <fieldset>
    			<legend>基础信息</legend>
				  <form  action="<%=basePath%>user/addUser" name="userForm" id="userForm" method="post" onsubmit="return submitTabCallback(this, callback, {tabClose:true, reftable:'userteble'}, '${tid}');">
					  <div class="row">
					 ...
					 <div class="row">
						  <div class="form-group">
						    ...
						    <div class="col-sm-3 control-text">
						      <input type="text" class="form-control datepicker" name="userBirthday"  placeholder="出生日期" data-date-format="yyyy-mm-dd" readonly="readonly">
						    </div>
					 ...
					 <div class="row">
						  <div class="form-group">
						    ...
						    <div class="col-sm-8 control-text">
						      <input type="text" class="form-control" name="userAddrsDetail" placeholder="家庭详址">
						    </div>						   
						  </div>
					 </div>
					 <div class="row">
