...
<div class="container-fluid">
	...
	<div class="row">
	  <div class="col-md-12 dataTablePanle">
	  	<div class="panel panel-default">
		  <div class="panel-body">
			<table class="table table-condensed table-bordered table-hover dataTable"><!-- 带边框、带过度效果、 紧凑型表格 -->
				<thead>
					<tr>
						<th class="box"><input type="checkbox" name="uid"/></th>
						<th class="no">序号</th>
						<th>账号</th>
						<th>用户名</th>
						<th>创建时间</th>
				...
				<tbody>
					<c:forEach items="${userList}" var="u">
						<tr>
							<td><input type="checkbox" value="${u.id}" name="_id"/></td><td>${u.id}</td><td>${u.userName}</td><td>${u.age}</td><td>2016-11-11</td><td>禁用</td><td><a class="btn btn-default" href="#" data-addtab="tabUserView" url="user/viewUser?id=${u.id}&type=2&tid=${tid}" title="查看用户">查看</a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>    
